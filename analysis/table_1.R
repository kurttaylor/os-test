...
# Save to CSV files
write_csv(table1_all$table_body, here::here("output", "table1.csv"))
write_csv(table1_strata$df_by, here::here("output", "table1_asthma.csv"))
# Save to HTML 
gtsave(as_gt(table1_all), here::here("output", "table1.html"))
gtsave(as_gt(table1_strata), here::here("output", "table1_asthma.html"))
